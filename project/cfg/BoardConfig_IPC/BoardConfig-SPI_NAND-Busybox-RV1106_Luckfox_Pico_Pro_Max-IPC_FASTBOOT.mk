...
# Kernel dts
export RK_KERNEL_DTS=rv1106g-luckfox-pico-pro-max-fastboot.dts
...
export LF_ENABLE_SPI_NAND_FAST_BOOT=y
...
#export RK_PARTITION_CMD_IN_ENV="64K(env),256K@64K(idblock),512K(uboot),384K(meta),36M(boot),3M(userdata)"
export RK_PARTITION_CMD_IN_ENV="256K(env),1M@256K(idblock),512K(uboot),2M(meta),32M(boot),20M(userdata)"
...
export RK_PARTITION_FS_TYPE_CFG=boot@IGNORE@erofs,userdata@/userdata@ubifs
...
# Uboot defconfig
export RK_UBOOT_DEFCONFIG=luckfox_rv1106_spi_nand_tb_defconfig
...
export RK_KERNEL_DEFCONFIG_FRAGMENT="luckfox_rv1106-tb.config rv1106-smart-door.config rv1106-nand.config"
...
# specify post.sh for delete/overlay files
export RK_POST_BUILD_SCRIPT=luckfox-rv1106-tb-spi_nand-post.sh
