...
# 	Board Config
#################################################
export LF_ORIGIN_BOARD_CONFIG=BoardConfig-SPI_NAND-Buildroot-RV1106_Core_Master-IPC.mk
# Target CHIP
...
# Kernel dts
export RK_KERNEL_DTS=rv1106g-core-master.dts
...
# Buildroot defconfig
export RK_BUILDROOT_DEFCONFIG=core_master_buildroot_defconfig
...
# Uboot defconfig
export RK_UBOOT_DEFCONFIG=core_master_rv1106_uboot_defconfig

# Kernel defconfig
export RK_KERNEL_DEFCONFIG=core_master_rv1106_kernel_defconfig
...
export RK_POST_OVERLAY="overlay-echo-mate-init overlay-luckfox-config overlay-luckfox-buildroot-init overlay-luckfox-buildroot-shadow"
